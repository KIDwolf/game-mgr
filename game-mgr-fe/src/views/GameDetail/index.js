...
import { game, InventoryLog } from '@/service';
import { CheckOutlined } from '@ant-design/icons-vue';
import { message } from 'ant-design-vue';
import Update from '@/views/Games/Update/index.vue';
...
export default defineComponent({
    ...
    setup() {
        ...
        const getDetail = async () => {
            const res = await game.detail(id);
        ...
        //删除操作
        const remove = async () => {
            const res = await game.remove(id)
        ...
        //更新操作
        const update = (game) => {
            Object.assign(detailInfo.value, game);
        };
        //日志分页切换的时候
